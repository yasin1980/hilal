...
public class MainActivity extends Activity {
    ...
    private static WeakReference<MainActivity> foregroundActivity =
    ...
    private static final String PERMISSION_PREFS =
            "hilal_permission_setup_v1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HilalAndroidBridge bridge =
                new HilalAndroidBridge();
        ...
        webView.postDelayed(
                this::startInitialPermissionFlow,
                700L
        );
    }
    ...
    public void onRequestPermissionsResult(
        ...
        if (requestCode
            ...
            webView.postDelayed(
                    this::continueInitialPermissionFlow,
                    300L
            );
        }
    }
    ...
    public class HilalAndroidBridge {
        ...
        public synchronized String consumePendingReminderId() {
            ...
            return pendingReminderId == null
                    ? ""
                    : pendingReminderId;
        }

        @JavascriptInterface
        public synchronized void acknowledgePendingReminderId(
                String id) {

            if (id != null
                    && id.equals(pendingReminderId)) {
